            ...
            >
                {
                    ...
                    blockingContact ? `Tem certeza que deseja bloquear este contato?` :
                    unBlockingContact ? `Tem certeza que deseja desbloquear este contato?` :
                        ...
                        {(popupState) => (
                            <React.Fragment>
                                ...
                                <Menu {...bindMenu(popupState)}>
                                    ...
                                    <MenuItem>
                                        <CSVLink style={{textDecoration: 'none', color: 'inherit', display: 'flex'}} separator=";"
